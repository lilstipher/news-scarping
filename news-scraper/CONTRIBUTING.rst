...
Welcome to ``news-scraper`` contributor's guide.
...
If you experience bugs or general issues with ``news-scraper``, please have a look
...
You can help improve ``news-scraper`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``news-scraper`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``news-scraper``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n news-scraper python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/news-scraper.git
    cd news-scraper
...
#. Install |pre-commit|_::
   ...
   ``news-scraper`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/news-scraper
.. _issue tracker: https://github.com/<USERNAME>/news-scraper/issues
.. <-- end -->
