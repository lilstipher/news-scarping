...
Welcome to ``news-api`` contributor's guide.
...
If you experience bugs or general issues with ``news-api``, please have a look
...
You can help improve ``news-api`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``news-api`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``news-api``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n news-api python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/news-api.git
    cd news-api
...
#. Install |pre-commit|_::
   ...
   ``news-api`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/news-api
.. _issue tracker: https://github.com/<USERNAME>/news-api/issues
.. <-- end -->
